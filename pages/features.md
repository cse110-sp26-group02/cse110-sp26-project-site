...
* Yes, OpenAI, Anthropic, Google, and other providers do give you token counts in their isolated online dashboards - but are they at your fingertips as a SWE?
* Not only do we allow you to see live usage from within your development workspace, but it offers:
    ...
    2. Organization per-Issue instead of per-commit. If it wasn't, it would be very hard to aggregate afterwards. That would also be very inconvenient because budgets cannot be controlled - so you'd end up with huge, un-payable bills that shut down your business! It is also the most natural way to track thought patterns. 
